...
// taken from https://etherscan.io/address/0xe84dcd8587287b997f51299430a396ad03aaec06#code with some modifications
...
contract OrderHelper {
    ...
    constructor(address _settlement) {
        settlement = GPv2SettlementContract(_settlement);
    }
    ...
    function getUid(
    ...
    ) public view returns (bytes32 digest, bytes memory orderUid) {
        ...
        digest = order.hash(settlement.domainSeparator());
        orderUid = digest.packOrderUidParams(address(this), validTo);
    }
}
