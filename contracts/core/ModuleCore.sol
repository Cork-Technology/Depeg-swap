...
contract ModuleCore is OwnableUpgradeable, UUPSUpgradeable, PsmCore, Initialize, VaultCore {
    ...
    function updatePoolsStatus(
        ...
        state.psm.isDepositPaused = isPSMDepositPaused;
        state.psm.isWithdrawalPaused = isPSMWithdrawalPaused;
        state.vault.config.isDepositPaused = isLVDepositPaused;
        state.vault.config.isWithdrawalPaused = isLVWithdrawalPaused;
