...
//             weth,
//             weth_wstETH_Expiry,
//             string.concat("PU", ERC20(weth).symbol(), "-", ERC20(wstETH).symbol()),
//             weth_wstETH_ARP
//         );
//         deployProtectedUnits(
//             weETH,
//             wstETH,
//             wstETH_weETH_Expiry,
//             string.concat("PU", ERC20(wstETH).symbol(), "-", ERC20(weETH).symbol()),
//             wstETH_weETH_ARP
//         );
//         deployProtectedUnits(
//             USDe,
//             sUSDS,
//             sUSDS_USDe_Expiry,
//             string.concat("PU", ERC20(sUSDS).symbol(), "-", ERC20(USDe).symbol()),
//             sUSDS_USDe_ARP
//         );
//         deployProtectedUnits(
//             USDT,
//             sUSDe,
//             sUSDe_USDT_Expiry,
//             string.concat("PU", ERC20(sUSDe).symbol(), "-", ERC20(USDT).symbol()),
//             sUSDe_USDT_ARP
//         );
//         vm.stopBroadcast();
//     }
