...
//             config.deployProtectedUnit(
//                 moduleCore.getId(mlETH, bsETH, mlETHExpiry, exchangeRateProvider),
//                 mlETH,
//                 bsETH,
//                 "mlETH - bsETH",
//                 INITIAL_MINT_CAP
...
//             config.deployProtectedUnit(
//                 moduleCore.getId(svbUSD, fedUSD, svbUSDExpiry, exchangeRateProvider),
//                 svbUSD,
//                 fedUSD,
//                 "svbUSD - fedUSD",
//                 INITIAL_MINT_CAP
...
//             config.deployProtectedUnit(
//                 moduleCore.getId(fedUSD, cusd, fedUSDExpiry, exchangeRateProvider),
//                 fedUSD,
//                 cusd,
//                 "fedUSD - cUSD",
//                 INITIAL_MINT_CAP
...
//             config.deployProtectedUnit(
//                 moduleCore.getId(omgUSD, svbUSD, omgUSDExpiry, exchangeRateProvider),
//                 omgUSD,
//                 svbUSD,
//                 "omgUSD - svbUSD",
//                 INITIAL_MINT_CAP
