...
import {RouterState, IDsFlashSwapCore} from "contracts/core/flash-swaps/FlashSwapRouter.sol";
...
contract RolloverTest is Helper {
    ...
    function test_RolloverWork() external {
        ...
        (uint256 ctReceived, uint256 dsReceived,) =
            moduleCore.rolloverExpiredCt(currencyId, DEFAULT_DEPOSIT_AMOUNT, prevDsId);
