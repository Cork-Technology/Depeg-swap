...
contract DepositTest is Helper {
    ...
    function testFuzz_deposit(uint8 raDecimals, uint8 paDecimals) external {
        ...
        uint256 received = moduleCore.depositLv(defaultCurrencyId, adjustedDepositAmount, 0, 0, 0);
    ...
    function test_basicSanityDepositRedeem() external {
...

        {
            ...
            received = moduleCore.depositLv(id, amount, 0, 0, 0);
        ...
        received = moduleCore.depositLv(id, 1 ether, 0, 0, 0);
    ...
    function test_depositRedeem() external {
        ...
        uint256 received = moduleCore.depositLv(id, amount, 0, 0, 0);
    ...
    function test_RevertWhenToleranceIsWorking() external {
        ...
        uint256 received = moduleCore.depositLv(id, amount, 0 ether, 0 ether, 0);

        vm.expectRevert();
        received = moduleCore.depositLv(id, amount, 100000 ether, 10000 ether, 0);
    }
    ...
    function test_redeemStateFailureStrict() external {
        ...
        moduleCore.depositLv(id, amount, 0, 0, 0); // a second deposit
        ...
        // should fail since we have PA deposited in PSM
        vm.expectRevert(IErrors.LVDepositPaused.selector);
        moduleCore.depositLv(id, 1 ether, 0, 0, 0);
    ...
    function test_depositInflation() external {
        ...
        received = moduleCore.depositLv(defaultCurrencyId, 1 ether, 0, 0, 0);
    ...
    function test_vaultExpiryRedeem() external {
        ...
        moduleCore.depositLv(id, amount, 0, 0, 0);
    ...
    function test_RevertWhenTryingToManipulateShares() external {
        ...
        moduleCore.depositLv(defaultCurrencyId, 100 ether, 0, 0, 0);
